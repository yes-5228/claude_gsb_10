...
class Issue(Base):
    ...
    assurance_id: Mapped[int | None] = mapped_column(
        ForeignKey("assurances.id", ondelete="SET NULL"), nullable=True, index=True,
        comment="所属保障",
    )
    ...
    assurance: Mapped["Assurance | None"] = relationship(back_populates="issues")  # noqa: F821
